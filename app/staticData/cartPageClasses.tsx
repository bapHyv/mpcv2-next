...
export const sectionClassname = "mt-2 p-3 sm:p-4 lg:col-span-5 lg:mt-4";
export const titleClassname = "relative mb-4 uppercase text-md text-black font-bold tracking-widest";
