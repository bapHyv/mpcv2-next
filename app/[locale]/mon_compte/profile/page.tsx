      ...
      <div className="max-w-5xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <fieldset className="col-span-1 md:col-span-2">
              ...
              <div className="flex items-center space-x-6">
                <label className="flex items-center space-x-2">
                  <input type="radio" name="title" value="Madame" className="text-teal-600 focus:ring-teal-600" />
                  <span>Madame</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input type="radio" name="title" value="Monsieur" className="text-teal-600 focus:ring-teal-600" />
                  <span>Monsieur</span>
                </label>
              </div>
            </fieldset>
            ...
            {/* Last Name */}
            <div>
              <label htmlFor="lastname" className="block text-sm font-bold">Nom</label>
              <input
                type="text"
                id="lastname"
                name="lastname"
            ...
            <div className="md:col-span-2">
              <label htmlFor="displayName" className="block text-sm font-bold">Nom affiché</label>
              <input
                type="text"
                id="displayName"
                name="displayName"
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Current Password */}
              <div className="md:col-span-2">
                <label htmlFor="currentPassword" className="block text-sm font-bold">Mot de passe actuel</label>
                <input
                  type="password"
                  id="currentPassword"
              ...
              {/* New Password */}
              <div>
                <label htmlFor="newPassword" className="block text-sm font-bold">Nouveau mot de passe</label>
                <input
                  type="password"
                  id="newPassword"
                  name="newPassword"
          ...
          <div>
            ...
            <fieldset className="space-y-4">
              <label className="flex items-start space-x-3">
                <input type="radio" name="preferences" value="promotions" className="mt-1 text-teal-600 focus:ring-teal-600" />
                <span>
              ...
              <label className="flex items-start space-x-3">
                <input type="radio" name="preferences" value="orders" className="mt-1 text-teal-600 focus:ring-teal-600" />
                <span>
                  Informations sur le compte et les commandes
                  <p className="text-sm text-teal-500">
                    Recevez des informations importantes au sujet de vos commandes et de votre compte.
                  </p>
                </span>
              </label>
            </fieldset>
