...
export default function Page() {
  return (
    <article>
      <h1>Aux origines du chanvre</h1>
      <p>
        Le cannabis, ou <i>Cannabis Sativa L</i>., est un genre de plante à{" "}
        <a href="https://monplancbd.fr" target="_blank" rel="noopener">
          fleurs
        </a>{" "}
        qui pousse nativement dans de nombreuses parties du monde, en particulier dans les zones tropicales et humides, ainsi que dans les régions
      ...
      <p>
        ...
        vêtements et de cordes. Ils l&apos;utilisent aussi comme médicament pour traiter de nombreuses pathologies allant des rhumatismes aux crampes
        menstruelles.
      </p>
      <p>
        Des fragments de fibres de chanvre ont également été retrouvés dans d’anciennes chambres funéraires chinoises datant d’environ 1 000 ans avant
        Jésus-Christ. D’autres preuves archéologiques suggèrent que la culture et la consommation du cannabis en Chine remontent à 10 000 ans avant
      ...
      <aside>
        <p>
          Sources: <cite>Cibdol</cite>, <cite>RTS</cite>, <cite>OSC</cite>, <cite>Zamnesia</cite>, <cite>NORML</cite>,{" "}
          <cite>French Hemp Factory</cite>
        </p>
      </aside>
    </article>
  );
